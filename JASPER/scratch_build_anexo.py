...
output_path = "/home/gyro/Documents/TESIS/word-to-jrxml/JASPER/comisiones/anexoFirmaDocente.jrxml"
...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" 
	...
	<title>
		<band height="780" splitType="Stretch">
			...
			<!-- Titulo: Anexo -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="115" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c1" positionType="Float" />
			...
			<!-- Titulo: Universidad -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="130" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c2" positionType="Float" />
				<textElement textAlignment="Center">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- Titulo: Departamento -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="145" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4ea" positionType="Float" />
				<textElement textAlignment="Center">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- Titulo: Declaracion -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="165" width="555" height="30" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c3" positionType="Float" />
				<textElement textAlignment="Center">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- P3: Docente Intro -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="210" width="555" height="60" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c4" positionType="Float" />
			...
			<!-- P4: 1. Informacion -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="280" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c5" positionType="Float" />
			...
			<!-- P5: Informacion body -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="295" width="555" height="45" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c6" positionType="Float" />
				<textElement textAlignment="Justified" markup="html">
					<font fontName="Arial" size="11" />
				</textElement>
			...
			<!-- P6: 2. Declaracion -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="350" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c7" positionType="Float" />
				<textElement textAlignment="Left">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- P7: Declaracion body -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="365" width="555" height="30" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c8" positionType="Float" />
				<textElement textAlignment="Justified" markup="html">
					<font fontName="Arial" size="11" />
				</textElement>
			...
			<!-- P8: 3. Aporte autores -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="405" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4c9" positionType="Float" />
				<textElement textAlignment="Left">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- P9: Aporte intro -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="420" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d0" positionType="Float" />
			...
			<!-- P10: Aporte body -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="435" width="555" height="30" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d1" positionType="Float" />
				<textElement textAlignment="Left" markup="html">
					<font fontName="Arial" size="11" isBold="true" isUnderline="true" />
				</textElement>
				<textFieldExpression><![CDATA[$P{P_BLOQUE_APORTES_AUTORES}]]></textFieldExpression>
			</textField>

			<!-- P11: 4. Acuerdo presentacion -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="475" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d2" positionType="Float" />
				<textElement textAlignment="Left">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- P12: Acuerdo body -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="490" width="555" height="35" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d3" positionType="Float" />
				<textElement textAlignment="Justified" markup="html">
					<font fontName="Arial" size="11" />
				</textElement>
			...
			<!-- P13: Ciudad y fecha -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="535" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d4" positionType="Float" />
			...
			<!-- P14: 5. Firma title -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="560" width="555" height="15" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d5" positionType="Float" />
				<textElement textAlignment="Left">
					<font fontName="Arial" size="11" isBold="true" />
				</textElement>
			...
			<!-- P15: Firma body -->
			<textField isStretchWithOverflow="true">
				<reportElement x="0" y="575" width="555" height="30" uuid="9dfbc2c9-b1e1-7797-e550-62b21eaba4d6" positionType="Float" />
				<textElement textAlignment="Justified">
			...
			<!-- Bloque de Firma -->
			<frame>
				<reportElement x="0" y="630" width="555" height="135" uuid="7d7722ed-4bdd-441c-9ed1-d5021a5dffac" positionType="Float" />
				<textField>
					<reportElement x="0" y="0" width="555" height="15" uuid="cec7c112-8f8d-4c2a-bda2-511a66e6b9fa" />
					<textElement textAlignment="Center">
						<font fontName="Arial" size="11" />
					</textElement>
				...
				<textField>
					<reportElement x="0" y="15" width="555" height="15" uuid="cec7c112-8f8d-4c2a-bda2-511a66e6b9fb" />
					<textElement textAlignment="Center">
						<font fontName="Arial" size="10" />
					</textElement>
				...
				<textField>
					...
					<textFieldExpression><![CDATA[$P{P_DOCENTE_SOLICITANTE_NOMBRE}]]></textFieldExpression>
				</textField>
				<textField>
